...
public class Utils {
    ...
    public static final NamespacedKey noArrowConsumeKey = new NamespacedKey("score", "score-noarrowconsume");
    public static final NamespacedKey keyMaterialGroupFrom = new NamespacedKey("score", "score-materialgroupfrom");
    public static final NamespacedKey autoSmeltScoreKey = new NamespacedKey("score", "score-autosmelt");
    public static final NamespacedKey replaceDropScoreKey = new NamespacedKey("score", "score-replacedrop");
